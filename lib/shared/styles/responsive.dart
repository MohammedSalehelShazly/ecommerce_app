...
class Responsive{
    ...
    double countryListTileHigh(BuildContext context){
        return isPortrait(context) ? sHeight(context) /12
            : sWidth(context) /12;
    }

    SizedBox mediumSizedBox(context)=> SizedBox(height: sHeight(context)*0.05,);
    SizedBox smallSizedBox (context)=> SizedBox(height: sHeight(context)*0.02,);
